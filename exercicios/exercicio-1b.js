...
const parOuImpar = list => list.forEach(element => element % 2 === 0 ? console.log('Par') : console.log('Impar'))

parOuImpar(lista)

// Instruções para teste:
//     Com o node instalado utilize os comandos CTRL + ALT + N
//     Para testar mais valores, insira no array 'lista' ou crie um novo e passa como parametro na chamada da função (linha 5)
